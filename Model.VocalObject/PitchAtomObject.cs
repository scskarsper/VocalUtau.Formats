    ...
    public class PitchAtomObject
    {
        ...
        public double PitchValue { 
            ...
            set
            {
                ...
                _pw = (int)Math.Round(pr * ((double)0x2000), 0);
                _key = getKey(_nn);
        ...
        public PitchAtomObject(uint NoteNumber, int PitchWheel, uint PBS = 1)
        {
            if (PBS < 1) PBS = 1;
            _nn = NoteNumber;
            _pw = PitchWheel;
        ...
        public PitchAtomObject(double PitchValue, uint PBS = 1)
        {
            if (PBS < 1) PBS = 1;
            _pv = PitchValue;
